              ...
              {displayedProducts.map((product) => {
                ...
                return (
                  <Card key={product.id} className="overflow-hidden hover:shadow-2xl transition-all duration-300 transform hover:scale-105 flex flex-col border-0 shadow-md">
                    <div className="relative h-64 bg-gradient-to-b from-blue-50 to-white flex items-center justify-center overflow-hidden">
                      <img
                        src={product.image}
                        alt={product.name}
                        loading="lazy"
                      ...
                      />
                      {product.inStock && (
                        <Badge className="absolute top-4 right-4 bg-green-600 shadow-lg">
                          متوفر | In Stock
                        </Badge>
                      )}
                    </div>
                    ...
                    <CardFooter className="flex flex-col gap-2">
                      <Button
                        ...
                        className="w-full bg-gradient-to-r from-green-500 to-green-600 hover:from-green-600 hover:to-green-700 text-white text-sm font-semibold shadow-lg transform transition hover:shadow-xl"
                      >
