    ...
    <section id="contact" className="py-20 bg-gray-50">
      <div className="container mx-auto px-4">
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
          <Card>
            <CardHeader>
              <CardTitle className="text-2xl text-blue-900">معلومات الاتصال | Contact Info</CardTitle>
            </CardHeader>
            <CardContent className="space-y-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="font-semibold text-lg mb-1">الهاتف | Phone</h3>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="font-semibold text-lg mb-1">واتساب | WhatsApp</h3>
                  <p className="text-gray-600 mb-2 direction-ltr">{phone}</p>
                  <Button
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="font-semibold text-lg mb-1">البريد الإلكتروني | Email</h3>
